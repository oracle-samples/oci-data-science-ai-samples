...
##########################################################################
# object_storage_text_extraction_processor_job_demo.py
#
# Supports Python 3
##########################################################################
# Info:
...
"""
This sample script creates an asynchronous processor job to perform text extraction on text_extraction_demo.jpg
...
samplefile = "resources/text_extraction_demo.jpg"
...
# Specify the text extraction eature
text_extraction_feature_searchable_pdf = oci.ai_document.models.DocumentTextExtractionFeature()
# Additionally, specify the option to generate a searchable PDF
text_extraction_feature_searchable_pdf.generate_searchable_pdf = False   # use True to generate the PDF
