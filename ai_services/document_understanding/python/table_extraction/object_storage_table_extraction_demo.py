...
##########################################################################
# object_storage_table_extraction_demo.py
#
# Supports Python 3
##########################################################################
# Info:
...
# python object_storage_table_extraction_demo.py
##########################################################################
...
The sample attempts to extract table information from a document in object storage.
...
object_location.object_name = "<enter-your-object-name-here>"  # e.g "table_demo.jpg"
