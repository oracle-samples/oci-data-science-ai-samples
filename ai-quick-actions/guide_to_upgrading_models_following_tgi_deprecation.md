...
1. Use the Python SDK to get the details for the target model.
...
2. Use the response from the "Get Model" call to update the custom_metadata_list within Update model python SDK code.
