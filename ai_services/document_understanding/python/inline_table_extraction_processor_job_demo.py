...
##########################################################################
# inline_table_extraction_processor_job_demo.py
#
# Supports Python 3
##########################################################################
# Info:
...
with open("resources/table_extraction_demo.pdf", "rb") as document_file:
...
# Specify the Table Extraction feature for this processor job
...
# Create a processor job for table extraction
