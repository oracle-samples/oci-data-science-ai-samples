...
# modulesPath = "/opt/sdxl/modules"
# sys.path.append(modulesPath)

# import modules.PwCSDXL
from modules import PwCSDXL
import yaml
...
async def generate(request: Request) -> Response:
    ...
    buffered = BytesIO()
    image = PwCSDXL.generate_from_text(text, negative_text, seed, base_steps, refiner_steps, width=width, height=height)
