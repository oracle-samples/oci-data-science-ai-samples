...
Download the example Spark application: [time_series_join.py](./time_series_join.py).
...
Add the following to arguments. In the sample CSV file, there are 3 inputs for Object Store Data. You may want to add more depending on the use case:
```
