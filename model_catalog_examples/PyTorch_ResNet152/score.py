...
# code snippet source: https://github.com/pytorch/vision/blob/v0.8.2/torchvision/models/resnet.py
...
def predict(data, model=load_model()):
    ...
    with torch.no_grad():
        pred = torch.nn.functional.softmax(model(X)[0], dim=0).argmax().item()
