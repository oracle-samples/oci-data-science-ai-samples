...
## Contents
 ...
 - [OCI Data Science - Useful Tips](#adw_ads-performance.ipynb)
...
This notebook was developed on the conda pack with slug and/or libraries: `generalml_p38_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `computervision_p37_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `pyspark30_p37_cpu_v5`
...
This notebook was developed on the conda pack with slug and/or libraries: `nlp_p37_cpu_v2`
...
---
### <a name="adw_ads-performance.ipynb"></a> - OCI Data Science - Useful Tips
#### [`adw_ads-performance.ipynb`](adw_ads-performance.ipynb)

 
Useful tips when using Oracle data science libraries

This notebook was developed on the conda pack with slug and/or libraries: `oracle-ads, ocifs`

 
`data science`  `oci`  `autonomous data warehouse`
...
This notebook was developed on the conda pack with slug and/or libraries: `sklearnex202130_p37_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `dbexp_p38_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `pyspark32_p38_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `pyspark32_p38_cpu_v2`
...
This notebook was developed on the conda pack with slug and/or libraries: `pyspark24_p37_cpu_v3`
...
This notebook was developed on the conda pack with slug and/or libraries: `pytorch110_p38_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `dataexpl_p37_cpu_v3`
...
This notebook was developed on the conda pack with slug and/or libraries: `tensorflow28_p38_cpu_v1`
...
This notebook was developed on the conda pack with slug and/or libraries: `rapids2110_p37_gpu_v1`
