...
```
```
wget -O model_repository/densenet_onnx/1/model.onnx https://github.com/tsikiksr/oci-data-science-ai-samples/blob/master/model-deployment/containers/Triton/model.onnx
```
