...
# Multiple Inference Endpoints (MIE): configure predict_api_specification (e.g. "openai")
# and/or custom_http_endpoints under OcirModelDeploymentEnvironmentConfigurationDetails;
# see the Oracle "Multiple Inference Endpoints" user guide and samples/README.md.
